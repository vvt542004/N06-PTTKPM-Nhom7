    ...
    <div class="body">
            ...
            <div class="body-right">
                ...
                <div class="product">
                    ...
                    @include('parts.body-right-item1')  
                    

                    <div class="lam-trang">
                        <p class="lam-SanPham-next">
                            <a href="/sanpham/1"><i class="fa-solid fa-arrow-left"></i> Trang trước</a>
                        </p>

                        <div class="lam-SanPham-trang">
                            <a href="/sanpham/1">1</a>
                            <p class="lam-trang1">2</p>
                            <a href="/sanpham/3">3</a>
                        </div>
                        
                        <p class="lam-SanPham-next">
                            <a href="/sanpham/3">Trang sau <i class="fa-solid fa-arrow-right"></i></a>
                        </p>
                    </div>
                </div>
            </div>
